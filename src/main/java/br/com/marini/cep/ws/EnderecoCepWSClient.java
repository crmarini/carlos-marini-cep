...
//
//import br.com.marini.cep.converter.StringListConverter;
//import br.com.marini.cep.dto.EnderecoCepDTO;
//
//public class EnderecoCepWSClient {
...
//				properties.load(is);
//				
//				BASE_URL = (String)properties.getProperty("enderecoCep.restws.url");	
//				
//			} catch (IOException e) {				
...
//	 * @return
//	 */
//	public List<EnderecoCepDTO> getEnderecoForCep(String numeroCep) {	
//		Integer
//		
//		Client client = ClientBuilder.newClient();
//		WebTarget myResource = client.target(BASE_URL + "/overAge").path();
//		
